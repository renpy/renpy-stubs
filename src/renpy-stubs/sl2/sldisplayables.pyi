...
def sl2bar(context: SLContext | None = None, **properties: Incomplete) -> renpy.display.behavior.Bar: ...
def sl2vbar(context: SLContext | None = None, **properties: Incomplete) -> renpy.display.behavior.Bar: ...
def sl2viewport(context: SLContext | None = None, **kwargs: Incomplete) -> Displayable: ...
def sl2vpgrid(context: SLContext | None = None, **kwargs: Incomplete) -> Displayable: ...
def sl2add(
