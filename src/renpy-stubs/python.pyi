...
def py_eval_bytecode(
    bytecode: str, globals: dict[str, Any] | None = None, locals: dict[str, Any] | None = None
) -> Any: ...
def py_eval(code: str, globals: dict[str, Any] | None = None, locals: dict[str, Any] | None = None) -> Any: ...
