...
class Preference:
    ...
    default: Incomplete
    types: Incomplete
    def __init__(self, name: Incomplete, default: Incomplete, types: Incomplete = None) -> None: ...
...
class Preferences(renpy.object.Object):
    ...
    def init(self) -> None: ...
    def reset(self) -> None: ...
    def check(self) -> Incomplete: ...
    def after_upgrade(self, version: int) -> None: ...
    def __init__(self) -> None: ...
    def set_volume(self, mixer: Incomplete, volume: Incomplete) -> None: ...
    def get_volume(self, mixer: Incomplete) -> Incomplete: ...
    def set_mixer(self, mixer: Incomplete, volume: Incomplete) -> None: ...
    def get_mixer(self, mixer: Incomplete) -> Incomplete: ...
    def set_mute(self, mixer: Incomplete, mute: Incomplete) -> None: ...
    def get_mute(self, mixer: Incomplete) -> Incomplete: ...
    def init_mixers(self) -> None: ...
    def get_all_mixers(self) -> Incomplete: ...
