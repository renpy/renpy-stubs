...
from typing import Any, Callable, Container, Iterable, Literal, Protocol, Self, overload
...
from renpy.display.layout import Position as Position
...
class Condition(Layer):
    ...
    condition: str | None
    image: Displayable | None
    def __init__(self, condition: str | None, image: Displayable | None, **kwargs: Incomplete) -> None: ...
    def apply_format(self, li: LayeredImage) -> Incomplete: ...
...
class Always(Layer):
    image: Displayable | None
    def __init__(self, image: Displayable | None, **kwargs: Incomplete) -> None: ...
    def apply_format(self, li: LayeredImage) -> Incomplete: ...
    def get_displayable(self, attributes: Iterable[str]) -> Displayable | None: ...
