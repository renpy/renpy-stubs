...
class Layer:
    ...
    def apply_format(self, li: LayeredImage, /) -> None: ...
...
class Condition(Layer):
    ...
    condition: str | None
    image: Displayable | None
    def __init__(self, condition: str | None, image: Displayable | None, **kwargs: Any) -> None: ...
    def apply_format(self, li: LayeredImage) -> None: ...
...
class Always(Layer):
    image: Displayable | None
    def __init__(self, image: Displayable | None, **kwargs: Any) -> None: ...
    def apply_format(self, li: LayeredImage) -> None: ...
    def get_displayable(self, attributes: Iterable[str]) -> Displayable | None: ...
