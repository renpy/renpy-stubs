...
class ConsoleReporter(Reporter):
    ...
    def test_suite_start(self, outcome, depth: int = 0) -> None: ...
    def test_suite_end(self, outcome, depth: int = 0) -> None: ...
    def test_case_start(self, outcome, depth: int = 0) -> None: ...
    def test_case_end(self, outcome, depth: int = 0) -> None: ...
    def test_hook_start(self, outcome, depth: int = 0) -> None: ...
    def test_hook_end(self, outcome, depth: int = 0) -> None: ...
    def test_case_skipped(self, outcome, depth: int = 0) -> None: ...
    def log_assert(self, assert_node, status, node_name: str = "") -> None: ...
