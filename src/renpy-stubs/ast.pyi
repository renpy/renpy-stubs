...
class Node(Object):
    ...
    @name.setter
    def name(self, value: NodeName) -> None: ...
    ...
    def replace_next(self, old: Node, new: Node | None) -> None: ...
...
def chain_block(block: Sequence[Node], next: Node | None) -> None: ...
...
type ImspecType = "tuple[tuple[str, ...], str | None, str | None, list[str], str | None, int | None, list[str] | None] |\ntuple[tuple[str, ...], str | None, str | None, list[str], str | None, int | None] |\ntuple[tuple[str, ...], list[str], str | None]"
...
class Init(Node):
    block: Sequence[Node]
    priority: SignedInt
    def __init__(self, loc: NodeLocation, block: Sequence[Node], priority: SignedInt) -> None: ...
    def get_children(self, f: Callable[[Node], Any]) -> None: ...
    def execute_init(self) -> None: ...
...
class While(Node):
    condition: str
    block: Sequence[Node]
    def __init__(self, loc: NodeLocation, condition: str, block: Sequence[Node]) -> None: ...
    def diff_info(self) -> tuple[type, str]: ...
    def get_children(self, f: Callable[[Node], Any]) -> None: ...
    next: Node | None
    def chain(self, next: Node | None) -> None: ...
...
class UserStatement(Node):
    ...
    def restructure(self, callback: Callable[[list[Node]], Any]) -> None: ...
    def diff_info(self) -> tuple[type, str]: ...
    def call(self, method: str, *args: Any, **kwargs: Any) -> Any | None: ...
    def execute_init(self) -> None: ...
    def get_init(self) -> SignedInt | None: ...
    def execute(self) -> None: ...
    def execute_default(self, start: bool) -> None: ...
    def predict(self) -> list[Node | None]: ...
...
class Define(Node):
    ...
    def early_execute(self) -> None: ...
    def execute(self) -> None: ...
    def redefine(self, stores: list[str]) -> None: ...
    def set(self) -> None: ...
...
class TranslateBlock(Node):
    ...
    block: Sequence[Node]
    language: str | None
    def __init__(self, loc: NodeLocation, language: str | None, block: Sequence[Node]) -> None: ...
    def get_children(self, f: Callable[[Node], Any]) -> None: ...
    next: Node | None
    def chain(self, next: Node | None) -> None: ...
    def execute(self) -> None: ...
