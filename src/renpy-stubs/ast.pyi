...
class Node(Object):
    ...
    @name.setter
    def name(self, value: NodeName) -> Incomplete: ...
    ...
    def scry(self) -> Scry: ...
    def restructure(self, callback: Callable[[list["Node"]], Any]) -> Incomplete: ...
...
class UserStatement(Node):
    ...
    def restructure(self, callback: Callable[[list[Node]], Any]) -> Incomplete: ...
    def diff_info(self) -> tuple[type, str]: ...
    def call(self, method: str, *args: Incomplete, **kwargs: Incomplete) -> Any | None: ...
    def execute_init(self) -> None: ...
    def get_init(self) -> SignedInt | None: ...
    def execute(self) -> None: ...
    def execute_default(self, start: Incomplete) -> None: ...
    def predict(self) -> list[Node | None]: ...
...
class Define(Node):
    ...
    def early_execute(self) -> None: ...
    def execute(self) -> None: ...
    def redefine(self, stores: list[str]) -> Incomplete: ...
    def set(self) -> None: ...
