...
@overload
def combine_redraw(a: None, b: None) -> None: ...
@overload
def combine_redraw(a: None, b: float) -> float: ...
@overload
def combine_redraw(a: float, b: None) -> float: ...
@overload
def combine_redraw(a: float, b: float) -> float: ...
def combine_redraw(a: float | None, b: float | None) -> float | None: ...
def to_uniform_value(shader_name: str, uniform_name: str, variable_types: dict[str, str], value: Any) -> Any: ...
...
def create_textshader_args_dict(name: str, shader: TextShader, s: str) -> dict[str, Any]: ...
@overload
