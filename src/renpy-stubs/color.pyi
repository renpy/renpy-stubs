...
class Color(tuple[int, int, int, int]):
    ...
    @overload
    def __new__(
        cls, *, hsv: tuple[float, float, float], alpha: float = 1.0, hls: tuple[float, float, float]
    ) -> Color: ...
    @overload
    def __new__(
        cls, *, rgb: tuple[float, float, float], alpha: float = 1.0, hls: tuple[float, float, float]
    ) -> Color: ...
    @overload
    def __new__(cls, *, alpha: float = 1.0, hls: tuple[float, float, float]) -> None: ...
    @property
    def hexcode(self) -> str: ...
    def __getnewargs__(self) -> tuple[tuple[int, int, int, int]]: ...
    @property
