...
def get_serial() -> Incomplete: ...

AudioNotReady: Incomplete

def load(fn: Incomplete) -> Incomplete: ...

class AudioData(str):
    data: bytes
    def __new__(cls, data: bytes, filename: str) -> Incomplete: ...
    def __init__(self, data: Incomplete, filename: Incomplete) -> None: ...
...
class Channel:
    ...
    def __init__(
        ...
        buffer_queue: Incomplete,
        movie: Incomplete,
        framedrop: Incomplete,
        synchro_start: Incomplete,
    ) -> None: ...
    def get_number(self) -> Incomplete: ...
    number: Incomplete
    def get_context(self) -> Incomplete: ...
    context: Incomplete
    def copy_context(self) -> Incomplete: ...
    def split_filename(
    ...
    def fadeout(self, secs: Incomplete) -> None: ...
    def reload(self) -> None: ...
    def set_audio_filter(self, audio_filter: Incomplete, replace: bool = False, duration: float = 0.016) -> None: ...
    def enqueue(
        self,
        filenames: Incomplete,
        loop: bool = True,
        synchro_start: Incomplete = None,
        fadein: float = 0,
        tight: Incomplete = None,
        loop_only: bool = False,
        relative_volume: float = 1.0,
    ) -> None: ...
    def get_playing(self) -> Incomplete: ...
    def set_volume(self, volume: Incomplete) -> None: ...
    def get_pos(self) -> Incomplete: ...
    def get_duration(self) -> Incomplete: ...
    def set_pan(self, pan: Incomplete, delay: Incomplete) -> None: ...
    def set_secondary_volume(self, volume: float, delay: float) -> None: ...
    def pause(self) -> None: ...
    def unpause(self) -> None: ...
    def read_video(self) -> Surface | None: ...
    def video_ready(self) -> Incomplete: ...
...
def alias_channel(name: Incomplete, newname: Incomplete) -> None: ...
def get_channel(name: str) -> Channel: ...
def set_force_stop(name: Incomplete, value: Incomplete) -> None: ...
...
def pump() -> None: ...
def rollback() -> None: ...
def autoreload(_fn: Incomplete) -> None: ...
def pause_all() -> None: ...
