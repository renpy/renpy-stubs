...
from typing import Any, Literal, NamedTuple, Never, overload
...
class ParseError(SyntaxError):
    ...
    def defer(self, queue: list[Any]) -> None: ...
...
class Lexer:
    ...
    def checkpoint(self) -> tuple[int, str, int, str, list[GroupedLine], int, int, str | None]: ...
    def revert(self, state: tuple[int, str, int, str, list[GroupedLine], int, int, str | None]) -> None: ...
    def get_location(self) -> tuple[str, int]: ...
    def require(self, thing: str | Callable[..., str | None], name: str | None = None, **kwargs: Any) -> str: ...
...
NEED_MUNGE_PATTERN: re.Pattern[str]
