...
from typing import Callable, NamedTuple, Never
...
class Lexer:
    ...
    def deferred_error(self, queue: str, msg: str) -> ParseError: ...
    def eol(self): ...
    ...
    def simple_expression(self, comma: bool = False, operator: bool = True, image: bool = False) -> str: ...
