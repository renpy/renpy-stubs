...
RectLike = renpy.pygame.rect.RectLike
...
class Surface:
    ...
    def fill(self, color: ColorLike, rect: RectLike | None = None, special_flags: int = 0) -> Rect: ...
    ...
    def get_rect(self, **kwargs: Incomplete) -> Rect: ...
    ...
    def subsurface(self, *args: RectLike) -> "Surface": ...
