...
class Canvas:
    ...
    def aalines(
        self, color: Incomplete, closed: bool, pointlist: Sequence[tuple[int, int]], blend: int = 1
    ) -> None: ...
    def arc(
    ...
    def lines(self, color: Incomplete, closed: bool, pointlist: Sequence[tuple[int, int]], width: int = 1) -> None: ...
    def polygon(self, color: Incomplete, pointlist: Sequence[tuple[int, int]], width: int = 0) -> None: ...
