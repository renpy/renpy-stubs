...
from typing import Any, Callable, Literal, Self, Protocol
...
class Container(renpy.display.displayable.Displayable):
    ...
    def set_transform_event(self, event: str) -> Incomplete: ...
    def _handles_event(self, event: str) -> bool: ...
    def set_style_prefix(self, prefix: str, root: bool) -> None: ...
    def _duplicate(self, args: DisplayableArguments | None) -> Container: ...
    _duplicatable: bool
...
def Composite(size: tuple[float, float], *args: Incomplete, **properties: Incomplete) -> MultiBox: ...

LiveComposite = Composite

class Position(Container):
    def __init__(
        self, child: DisplayableLike, style: renpy.style.StyleLike = "image_placement", **properties
    ) -> None: ...
    offsets: list[tuple[float, float]]
    def render(self, width: float, height: float, st: float, at: float) -> renpy.display.render.Render: ...
...
def Fixed(**properties: Incomplete) -> MultiBox: ...
...
class Window(Container):
    ...
    def __init__(
        self, child: DisplayableLike | None = None, style: renpy.style.StyleLike = "window", **properties
    ) -> None: ...
...
class DynamicDisplayable(renpy.display.displayable.Displayable):
    ...
    args: Incomplete
    kwargs: Incomplete
    def __init__(self, function: DynamicDisplayableFunction, *args: Incomplete, **kwargs: Incomplete) -> None: ...
    def _duplicate(self, args: DisplayableArguments | None) -> DynamicDisplayable: ...
    def visit(self) -> list[Displayable]: ...
...
def ConditionSwitch(*args: Incomplete, **kwargs: Incomplete) -> Position: ...
def ShowingSwitch(*args: Incomplete, **kwargs: Incomplete) -> Position: ...
...
def Crop(rect: tuple[float, float, float, float], child: DisplayableLike, **properties) -> Incomplete: ...
...
class Side(Container):
    ...
    def __init__(self, positions: str | list[str], style: renpy.style.StyleLike = "side", **properties) -> None: ...
    def add(self, d: DisplayableLike) -> None: ...
    def _clear(self) -> None: ...
    def per_interact(self) -> None: ...
    cwidth: Incomplete
...
class Tile(Container):
    def __init__(self, child: DisplayableLike, style: renpy.style.StyleLike = "tile", **properties) -> None: ...
    def render(self, width: float, height: float, st: float, at: float) -> renpy.display.render.Render: ...
...
class AlphaMask(Container):
    ...
    def _duplicate(self, args: DisplayableArguments | None) -> AlphaMask: ...
    def _unique(self) -> None: ...
    def visit(self) -> Incomplete: ...
    offsets: Incomplete
    def render(self, width: float, height: float, st: float, at: float) -> renpy.display.render.Render: ...
...
class Layer(AdjustTimes):
    ...
    start_time: Incomplete
    anim_time: Incomplete
    def add(self, d: DisplayableLike, st: float | None = None, at: float | None = None) -> Incomplete: ...
