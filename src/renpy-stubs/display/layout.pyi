...
class Container(renpy.display.displayable.Displayable):
    ...
    def render(self, width: float, height: float, st: float, at: float) -> renpy.display.render.Render: ...
    def event(self, ev: renpy.pygame.event.EventType, x: float, y: float, st: float) -> Any: ...
    def visit(self): ...
    def __enter__(self): ...
    def __exit__(
...
def default_modal_function(ev, x: float, y: float, w: float | None, h: float | None) -> bool: ...
def check_modal(
...
class MultiBox(Container):
    ...
    order_reverse: bool
    layout: Incomplete
    _layer_at_list: Incomplete
    _camera_list: Incomplete
    layers: Incomplete
    untransformed_layer: Incomplete
    adjust_times: bool
    ...
    def _clear(self) -> None: ...
    def _in_current_store(self) -> MultiBox: ...
