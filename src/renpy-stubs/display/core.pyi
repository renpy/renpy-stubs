...
class Renderer:
    ...
    def render_to_texture(self, what: Render, alpha: bool) -> Texture: ...
    def is_pixel_opaque(self, what: Render, x: float, y: float) -> bool: ...
    ...
    def mouse_event(self, ev: EventType) -> tuple[int, int]: ...
...
class Interface:
    ...
    prediction_coroutine: Generator[bool | None, bool | None] | None
    did_autosave: bool
    did_persistent: bool
