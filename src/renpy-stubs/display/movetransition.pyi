...
def MoveFactory(pos1: Rect, pos2: Rect, delay: float, d: MultiBox, **kwargs: Incomplete) -> MultiBox: ...
def default_enter_factory(pos: Rect, delay: float, d: MultiBox, **kwargs: Incomplete) -> MultiBox: ...
def default_leave_factory(pos: Rect, delay: float, d: MultiBox, **kwargs: Incomplete) -> None: ...
def MoveIn(
    pos: tuple[float, float], pos1: tuple[float, float], delay: float, d: Incomplete, **kwargs: Incomplete
) -> Incomplete: ...
def MoveOut(
    pos: tuple[float, float], pos1: tuple[float, float], delay: float, d: Incomplete, **kwargs: Incomplete
) -> Incomplete: ...
def ZoomInOut(start: float, end: float, pos: Rect, delay: float, d: Incomplete, **kwargs: Incomplete) -> Incomplete: ...
def RevolveInOut(
    start: float, end: float, pos: Rect, delay: float, d: Incomplete, **kwargs: Incomplete
) -> Incomplete: ...
...
class MoveInterpolate(renpy.display.displayable.Displayable):
    ...
    def child_placement(self, child: Incomplete) -> Placement: ...
