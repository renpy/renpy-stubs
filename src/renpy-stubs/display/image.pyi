...
class ImageReference(Displayable):
    ...
    _duplicatable: bool
    def _duplicate(self, args: DisplayableArguments | None = None) -> ImageReference: ...
...
class DynamicImage(Displayable):
    ...
    def _scope(self, scope: dict[str, Any] | None, update: bool) -> bool | None: ...
    def _repr_info(self) -> str: ...
    def __hash__(self) -> int: ...
    def __eq__(self, o: object) -> bool: ...
    ...
    def _duplicate(self, args: DisplayableArguments | None = None) -> DynamicImage: ...
    def _unique(self) -> None: ...
    def _in_current_store(self) -> Self: ...
    def _handles_event(self, event: str) -> bool: ...
    def _hide(self, st: float, at: float, kind: Literal["hide", "replace", "cancel"]) -> Displayable | None: ...
...
class ShownImageInfo(renpy.object.Object):
    ...
    def choose_image(
        self, tag: str, required: list[str], optional: list[str], exception_name: tuple[str, ...] | None
    ) -> tuple[str, ...] | None: ...
