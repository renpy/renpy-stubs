...
class ImageBase(Displayable):
    ...
    def __init__(self, *args: Incomplete, **properties: Incomplete) -> None: ...
...
def load_image(im: Incomplete) -> Render: ...
def load_surface(im: Incomplete) -> Surface: ...
...
class Composite(ImageBase):
    ...
    oversample: int
    const_size: bool
    def __init__(self, size: tuple[int, int] | None, *args: Incomplete, **properties: Incomplete) -> None: ...
    def get_hash(self) -> int: ...
    def load(self) -> Surface: ...
    def predict_files(self) -> list[str]: ...
...
class matrix(tuple):
    def __new__(cls, *args: Incomplete) -> Incomplete: ...
    def mul(
