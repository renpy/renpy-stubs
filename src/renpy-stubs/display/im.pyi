...
T = TypeVar("T")
type ImageDescriptionBase = ImageBase | str | ImageReference
type ImageDescription = ImageDescriptionBase | tuple[ImageDescriptionBase, ...]
...
class UnoptimizedTexture(ImageBase):
    ...
    image: ImageBase
    const_size: bool
    def __init__(self, im: ImageDescription, **properties) -> None: ...
    def _repr_info(self) -> str: ...
    def get_hash(self) -> int: ...
    def load(self) -> Surface: ...
    def predict_files(self) -> list[str]: ...
...
@overload
def image(arg: tuple[ImageDescription, ...], loose: Literal[False] = ..., **properties) -> Composite: ...
@overload
...
class Scale(ImageBase):
    ...
    bilinear: bool
    const_size: bool
    def __init__(self, im: ImageDescription, width: int, height: int, bilinear: bool = True, **properties) -> None: ...
    def get_hash(self) -> int: ...
    def load(self) -> Surface: ...
    def predict_files(self) -> list[str]: ...
...
class FactorScale(ImageBase):
    ...
    const_size: bool
    def __init__(
        self, im: ImageDescription, width: float, height: float | None = None, bilinear: bool = True, **properties
    ) -> None: ...
    def get_hash(self) -> int: ...
    def load(self) -> Surface: ...
    def predict_files(self) -> list[str]: ...
...
class Flip(ImageBase):
    ...
    const_size: bool
    def __init__(
        self, im: ImageDescription, horizontal: bool = False, vertical: bool = False, **properties
    ) -> None: ...
    def get_hash(self) -> int: ...
    def load(self) -> Surface: ...
    def predict_files(self) -> list[str]: ...
...
class Rotozoom(ImageBase):
    ...
    zoom: float
    const_size: bool
    def __init__(self, im: ImageDescription, angle: float, zoom: float, **properties) -> None: ...
    def get_hash(self) -> int: ...
    def load(self) -> Surface: ...
    def predict_files(self) -> list[str]: ...
...
class Crop(ImageBase):
    @overload
    def __init__(self, im: ImageDescription, x: int, y: int, w: int, h: int, **properties) -> None: ...
    @overload
    def __init__(
        self,
        im: ImageDescription,
...
class Twocolor(ImageBase):
    ...
    force_alpha: bool
    def __init__(
        self, im: ImageDescription, white: ColorLike, black: ColorLike, force_alpha: bool = False, **properties
    ) -> None: ...
    def get_hash(self) -> int: ...
    def load(self) -> Surface: ...
    def predict_files(self) -> list[str]: ...
...
class Blur(ImageBase):
    ...
    ry: float
    const_size: bool
    def __init__(self, im: ImageDescription, xrad: float, yrad: float | None = None, **properties) -> None: ...
    def get_hash(self) -> int: ...
    def load(self) -> Surface: ...
    def predict_files(self) -> list[str]: ...
...
class MatrixColor(ImageBase):
    ...
    const_size: bool
    def __init__(
        self, im: ImageDescription, matrix: list[float] | tuple[float, ...] | matrix, **properties
    ) -> None: ...
    def get_hash(self) -> int: ...
    def load(self) -> Surface: ...
    def predict_files(self) -> list[str]: ...
...
def Grayscale(
    im: ImageDescription, desat: tuple[float, float, float] = (0.2126, 0.7152, 0.0722), **properties
) -> MatrixColor: ...
def Sepia(
    im: ImageDescription,
...
def Color(im: ImageDescription, color: ColorLike) -> Recolor: ...
def Alpha(image: ImageDescription, alpha: float, **properties) -> Recolor: ...
...
class Tile(ImageBase):
    ...
    size: tuple[int, int] | None
    const_size: bool
    def __init__(self, im: ImageDescription, size: tuple[int, int] | None = None, **properties) -> None: ...
    def get_hash(self) -> int: ...
    def load(self) -> Surface: ...
    def predict_files(self) -> list[str]: ...
...
class AlphaMask(ImageBase):
    ...
    oversample: int
    const_size: bool
    def __init__(self, base: ImageDescription, mask: ImageDescription, **properties) -> None: ...
    def get_hash(self) -> int: ...
    def load(self) -> Surface: ...
    def predict_files(self) -> list[str]: ...
