...
class ImageBase(Displayable):
    ...
    def __init__(self, *args: Any, **properties: Any) -> None: ...
...
class ZipFileImage(ImageBase):
    ...
    filename: str
    const_size: bool
    def __init__(self, zipfilename: str, filename: str, mtime: float = 0, **properties) -> None: ...
    def load(self) -> Surface: ...
    def predict_files(self) -> list[str]: ...
...
@overload
def image[T: ImageLike, R: ImageBase](arg: T, loose: Literal[True], **properties) -> R: ...
def expand_bounds(
...
def load_image(im: ImageLike) -> Render: ...
def load_surface(im: ImageLike) -> Surface: ...
...
class Composite(ImageBase):
    ...
    oversample: int
    const_size: bool
    def __init__(self, size: tuple[int, int] | None, *args: tuple[int, int] | ImageLike, **properties: Any) -> None: ...
    def get_hash(self) -> int: ...
    def load(self) -> Surface: ...
    def predict_files(self) -> list[str]: ...
...
class matrix(tuple):
    def __new__(cls, *args: float | tuple[float, ...]) -> matrix: ...
    def mul(
    ...
    __radd__ = __add__
    def __sub__(self, other: matrix | list[float] | tuple[float, ...] | int | float) -> matrix: ...
    def __rsub__(self, other: matrix | list[float] | tuple[float, ...] | int | float) -> matrix: ...
    @overload
