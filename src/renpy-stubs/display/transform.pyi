...
class Proxy:
    ...
    def __init__(self, name: str) -> None: ...
    def __get__(self, instance: Incomplete, owner: Incomplete) -> Incomplete: ...
    def __set__(self, instance: Incomplete, value: Incomplete) -> Incomplete: ...
...
class Transform(Container):
    ...
    def take_state(self, t: Transform | None) -> None: ...
    def take_execution_state(self, t: Transform | None) -> None: ...
