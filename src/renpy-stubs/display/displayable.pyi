...
from typing import Any, Callable, Literal, Self, TypedDict, Unpack, Self
...
class Displayable(renpy.object.Object):
    ...
    def _duplicate(self, args: DisplayableArguments | None = None) -> Displayable: ...
    def _get_tooltip(self) -> Any | None: ...
    def _in_current_store(self) -> Self: ...
    def _unique(self) -> None: ...
    def parameterize(self, name: tuple[str, ...], parameters: tuple[str, ...]) -> Self: ...
    ...
    def set_style_prefix(self, prefix: str, root: bool) -> bool: ...
    ...
    def _change_transform_child(
        self, child: renpy.display.transform.Transform | Displayable | None
    ) -> renpy.display.transform.Transform | Displayable | None: ...
