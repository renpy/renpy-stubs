...
class ScreenDisplayable(renpy.display.layout.Container):
    ...
    def find_focusable(
        self, callback: Callable[[Displayable | None, str | None], None], focus_name: str | None
    ) -> None: ...
    def copy(self) -> ScreenDisplayable: ...
    def _handles_event(self, event: str) -> bool: ...
    def _hide(self, st: float, at: float, kind: str) -> ScreenDisplayable | None: ...
    def _in_current_store(self) -> Self: ...
    def update(self) -> dict[str, Displayable]: ...
...
def get_all_screen_variants(name: str | tuple[str, ...]) -> list[Screen]: ...
...
def define_screen(*args: Any, **kwargs: Any) -> None: ...
...
def show_screen(_screen_name: str | tuple[str, ...], *_args: Any, **kwargs: Any) -> None: ...
def predict_screen(_screen_name: str | tuple[str, ...], *_args: Any, **kwargs: Any) -> None: ...
def hide_screen(tag: str, layer: str | None = None, immediately: bool = False) -> None: ...
def use_screen(_screen_name: str | tuple[str, ...], *_args: Any, **kwargs: Any) -> None: ...
