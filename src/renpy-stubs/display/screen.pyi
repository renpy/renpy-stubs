...
def define_screen(*args: Incomplete, **kwargs: Incomplete) -> None: ...
...
def show_screen(_screen_name: str | tuple[str, ...], *_args: Incomplete, **kwargs: Incomplete) -> None: ...
def predict_screen(_screen_name: str | tuple[str, ...], *_args: Incomplete, **kwargs: Incomplete) -> None: ...
def hide_screen(tag: str, layer: str | None = None, immediately: bool = False) -> None: ...
def use_screen(_screen_name: str | tuple[str, ...], *_args: Incomplete, **kwargs: Incomplete) -> None: ...
