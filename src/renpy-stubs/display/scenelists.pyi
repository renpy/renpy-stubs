...
class SceneListEntry(renpy.object.Object):
    ...
    def __iter__(self) -> Iterator[str | int | float | None | Displayable]: ...
    def __getitem__(self, index: int) -> Any: ...
    def copy(self) -> SceneListEntry: ...
...
class SceneLists(renpy.object.Object):
    ...
    def get_all_layer_tag_displayable(self) -> Generator[tuple[str, str | None, Displayable]]: ...
