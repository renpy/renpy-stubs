...
def reset() -> None: ...
def interact(type: str = "misc", roll_forward: Any | None = None, **kwargs: Incomplete) -> Any | None: ...
...
class Wrapper[T: Displayable](renpy.object.Object):
    ...
    def __call__(self, *args: Incomplete, **kwargs: Incomplete) -> T: ...

def _add(d: DisplayableLike, **kwargs: Incomplete) -> Displayable | renpy.display.transform.Transform: ...
...
class Choice:
    ...
    args: tuple[Any, ...] | None
    kwargs: dict[str, Any] | None
    def __init__(self, _value: Any, *args: Incomplete, **kwargs: Incomplete) -> None: ...
...
def _textbutton(
    ...
    clicked: renpy.display.behavior.ActionType | None = None,
...
def _bar(*args: Incomplete, **properties: Incomplete) -> renpy.display.behavior.Bar: ...
...
def viewport(**properties: Incomplete) -> renpy.display.viewport.Viewport: ...
def vpgrid(**properties: Incomplete) -> renpy.display.viewport.VPGrid: ...
...
def hotspot(*args: Incomplete, **kwargs: Incomplete) -> None: ...
def _hotbar(
...
def _jumpsoutofcontext(label: renpy.ast.NodeName) -> Never: ...

jumpsoutofcontext: renpy.curry.Partial[Callable[[renpy.ast.NodeName], Never]]

def callsinnewcontext(*args: Incomplete, **kwargs: Incomplete) -> Any: ...
def invokesinnewcontext(*args: Incomplete, **kwargs: Incomplete) -> Any: ...
def gamemenus(*args: Incomplete) -> Any: ...
