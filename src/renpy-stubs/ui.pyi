...
def reset() -> None: ...
def interact(type: str = "misc", roll_forward: Any | None = None, **kwargs: Any) -> Any | None: ...
...
def _add(d: DisplayableLike, **kwargs: Any) -> Displayable | renpy.display.transform.Transform: ...
...
class Choice:
    ...
    args: tuple[Any, ...] | None
    kwargs: dict[str, Any] | None
    def __init__(self, _value: Any, *args: Any, **kwargs: Any) -> None: ...
...
def _bar(*args: Any, **properties: Any) -> renpy.display.behavior.Bar: ...
...
def viewport(**properties: Any) -> renpy.display.viewport.Viewport: ...
def vpgrid(**properties: Any) -> renpy.display.viewport.VPGrid: ...
...
def hotspot(*args: Any, **kwargs: Any) -> None: ...
def _hotbar(
...
def callsinnewcontext(*args: Any, **kwargs: Any) -> Any: ...
def invokesinnewcontext(*args: Any, **kwargs: Any) -> Any: ...
def gamemenus(*args: Any) -> Any: ...
