...
class Analysis:
    ...
    def get_child(self, identifier: object) -> Analysis: ...
    ...
    def mark_constant(self, name: str | None) -> None: ...
    def mark_not_constant(self, name: str | None) -> None: ...
    ...
    def is_constant_expr(self, expr: renpy.ast.PyExpr | str) -> int: ...
