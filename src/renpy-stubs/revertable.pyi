...
def _reconstructor(cls, base: Incomplete, state: Incomplete) -> Incomplete: ...
...
def revertable_range(*args: Incomplete) -> RevertableList[int]: ...
def revertable_sorted[T](*args: list[Iterable[T]], **kwargs: Incomplete) -> RevertableList[T]: ...
...
class RevertableDefaultDict[KT, VT](RevertableDict[KT, VT]):
    ...
    def __init__(
        self, default_factory: Callable[..., VT] | None = None, *args: Incomplete, **kwargs: Incomplete
    ) -> None: ...
    def __missing__(self, key: KT) -> VT: ...

class RevertableSet[T](set[T]):
    def __setstate__(self, state: Incomplete) -> None: ...
    def __getstate__(self) -> Incomplete: ...
