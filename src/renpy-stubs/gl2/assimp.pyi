...
class MeshInfo:
    def __init__(self, loader, mesh, material_index, textures: Iterable[str], shaders: Iterable[str]) -> None: ...
    mesh: Mesh3
    shaders: Iterable[str]
    uniforms: dict[str, object]
    texture_uniforms: dict[str, Displayable]
...
def preload() -> None: ...
def render_for_texture(d, width, height, st, at) -> None: ...
def unoptimized_texture(d) -> None: ...
