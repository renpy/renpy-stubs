...
ShaderCache = renpy.gl2.gl2shadercache.ShaderCache  # type: ignore
Surface = renpy.pygame.surface.Surface  # type: ignore
...
class GL2Draw:
    ...
    def draw_screen(self, render_tree: Render | None, flip: bool = True, screenshot: bool = False) -> None: ...
    ...
    def load_texture(
        self, surf: Surface, transient: bool = False, properties: dict[str, Any] = {}
    ) -> Texture | GL2Model | Render: ...
    ...
    def screenshot(self, render_tree: Render | None) -> renpy.pygame.surface.Surface: ...
...
class GL2DrawingContext:
    ...
    def merge_uniforms(self, uniforms: dict[str, Any]) -> None: ...
