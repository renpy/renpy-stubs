...
class GL2Draw:
    ...
    def draw_screen(self, render_tree, flip: bool = True, screenshot: bool = False) -> None: ...
    def event_peek_sleep(self) -> None: ...
    def flip(self) -> None: ...
    def get_mouse_pos(self) -> None: ...
    def get_physical_size(self) -> None: ...
    def get_texture_size(self) -> None: ...
    def get_window_position(self, physical_size=None) -> None: ...
    def init(self, virtual_size) -> None: ...
    def init_fbo(self) -> None: ...
    def is_pixel_opaque(self, what) -> None: ...
    def kill_textures(self) -> None: ...
    def load_all_textures(self, what) -> None: ...
    def load_texture(self, surf, transient: bool = False, properties={}) -> None: ...
    def mouse_event(self, ev) -> None: ...
    ...
    def render_to_texture(self, what, alpha: bool = True, properties={}) -> None: ...
    def resize(self) -> None: ...
    def screenshot(self, render_tree) -> None: ...
    def select_framerate(self) -> None: ...
    def select_gl_attributes(self, gles) -> None: ...
    def select_physical_size(self, physical_size) -> None: ...
    ...
    def translate_point(self, x, y) -> None: ...
    def untranslate_point(self, x, y) -> None: ...
...
def set_cull_face(cull_face) -> None: ...
