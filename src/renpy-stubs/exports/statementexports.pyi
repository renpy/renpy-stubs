...
def call(label: renpy.ast.NodeName, *args: Incomplete, **kwargs: Incomplete) -> NoReturn: ...
def return_statement(value: Any | None = None) -> None: ...
def call_screen(_screen_name: str | tuple[str, ...], *args: Incomplete, **kwargs: Incomplete) -> Any | None: ...
