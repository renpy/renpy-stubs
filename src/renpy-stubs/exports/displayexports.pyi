...
from renpy.ui import BarValue as BarValue
...
def get_at_list(name: str | tuple[str, ...], layer: str | None = None) -> AtList | None: ...
...
def get_image_load_log(age: float | None = None) -> Generator[tuple[float, str, bool]]: ...
...
def get_adjustment(bar_value: BarValue) -> Adjustment: ...
