...
def blend(pysrc: Surface, pysrcb: Surface, pydst: Surface, alpha: int) -> None: ...
...
def imageblend(pysrc: Surface, pysrcb: Surface, pydst: Surface, pyimg: Surface, aoff: int, amap: bytes) -> None: ...
